			...
			//var connection = new WebSocket('ws://192.168.1.234/socket/');
			...
			function validateForm() {
				...
				var y = document.forms["upform"]["filearg"].value;
				if (x == "") {
					alert("Name must be filled out");
					return false;
				}
				if (y == "") {
					alert("File must be filled selected");
					return false;
				}
			}
            ...
            function startup () {
                ...
                colorPicker.addEventListener("input", updateNow, false);
            }